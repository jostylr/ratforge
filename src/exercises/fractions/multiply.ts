...
export interface MultiplyFractionsParams {
  num1: number;
  den1: number;
  num2: number;
  den2: number;
...
export const multiplyFractionsExercise: Exercise = {
  id: "frac-multiply",
  topic: "fractions",
  title: "Multiply Fractions",
  description: "Multiply two fractions together",
  difficulty: 3,
  ...
  generate(seed?: number): ExerciseInstance {
    ...
    const num2 = randomInt(1, 4, random);
    const den2 = randomInt(num2 + 1, 6, random);
    
    let answerNum = num1 * num2;
    let answerDen = den1 * den2;
  ...
  validate(instance: ExerciseInstance, answer: unknown): ValidationResult {
    const params = instance.params as unknown as MultiplyFractionsParams;
    ...
    return { correct: false, feedback: `Not quite. Multiply numerators together, then multiply denominators together.` };
  },
  ...
  renderHTML(instance: ExerciseInstance): string {
    ...
    return `
      <div class="exercise-container" x-data="multiplyFractionsExercise()" x-init="$nextTick(() => $refs.numInput?.focus())">
        <div class="exercise-prompt">
          <h2>Multiply Fractions</h2>
          <p class="exercise-hint">Multiply numerator × numerator, denominator × denominator</p>
        </div>
        ...
        <div class="feedback-area" x-show="feedback" x-cloak>
          ...
          <div class="next-actions" x-show="submitted">
            ...
            <a href="/practice/frac-multiply" class="btn btn-primary" x-show="correct || givenUp" x-ref="nextBtn">
              Next Exercise
            </a>
      ...
      <script>
        function multiplyFractionsExercise() {
          return {
            answerNum: '',
            answerDen: '',
            activeField: 'num',

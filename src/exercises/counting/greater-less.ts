...
export interface GreaterLessParams {
  num1: number;
  num2: number;
  answer: 'greater' | 'less' | 'equal';
}

export const greaterLessExercise: Exercise = {
  id: "counting-greater-less",
  topic: "counting",
  title: "Greater, Less, or Equal",
  description: "Compare two numbers using >, <, or =",
  difficulty: 1,
  ...
  generate(seed?: number): ExerciseInstance {
    ...
    const num1 = randomInt(1, 20, random);
    // Sometimes make them equal
    const makeEqual = random() < 0.15;
    const num2 = makeEqual ? num1 : randomInt(1, 20, random);
  ...
  validate(instance: ExerciseInstance, answer: unknown): ValidationResult {
    const params = instance.params as unknown as GreaterLessParams;
    ...
    return { correct: false, feedback: `Not quite. Which number is bigger?` };
  },
  ...
  renderHTML(instance: ExerciseInstance): string {
    ...
    return `
      <div class="exercise-container" x-data="greaterLessExercise()">
        <div class="exercise-prompt">
          <h2>Compare the numbers</h2>
          <p class="exercise-hint">Is the first number greater than, less than, or equal to the second?</p>
        </div>
        ...
        <div class="feedback-area" x-show="feedback" x-cloak>
          ...
          <div class="next-actions" x-show="submitted">
            ...
            <a href="/practice/counting-greater-less" class="btn btn-primary" x-show="correct || givenUp" x-ref="nextBtn">
              Next Exercise
            </a>

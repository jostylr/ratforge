...
export function countingTopicPage(token: string): string {
  const exercises = [
    ...
    },
    {
      ...
      url: `/practice/counting-odd-even`,
      icon: "🔢",
      difficulty: 1 as const,
    },
    {
      title: "Greater, Less, Equal",
      description: "Compare numbers with >, <, =",
      url: `/practice/counting-greater-less`,
      icon: "↔️",
      difficulty: 1 as const,
    },
    {
    ...
    {
      title: "Order Numbers",
      description: "Arrange numbers from least to greatest",
      url: `/practice/counting-ordering`,
      icon: "📊",
      difficulty: 2 as const,
    },
    {
      title: "Number Names",
      description: "Words for numbers: one, two, three...",
      url: `/practice/counting-names`,
      icon: "📝",
      difficulty: 1 as const,
    },
    {
      title: "Ordinal Numbers",
      description: "First, second, third... positions",
      url: `/practice/counting-ordinal`,
      icon: "🏆",
      difficulty: 2 as const,
    },
    {
      title: "Roman Numerals",
      description: "Learn I, V, X, L, C...",
      url: `/practice/counting-roman`,
      icon: "🏛️",
